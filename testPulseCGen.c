...
int outError;
  ...
  //  division = atof(argv[5]);
    ...
    printf("testPulseCGen <Amplitude> <Frequency> <Amperemeter-Stage> <Voltmeter-Amplification> <Vm-division>\n");
    printf("\n");
  ...
  ContiniusPulseGeneration(freq, amp);
  ...
  */
  ...
  outError=setVoltmeter(amplification, 0);  // division  WAS REMOVED
